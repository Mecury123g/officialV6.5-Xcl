exports.beta2 = async (Zynxzoo, target) => {
    for (let i = 0; i < 7; i++) {
        await Zynxzoo.relayMessage(target, 
            {
                viewOnceMessage: {
                    message: {
...
exports.beta1 = async (Zynxzoo, target) => {
    for (let i = 0; i < 7; i++) {
        await Zynxzoo.relayMessage(target, 
            {
                viewOnceMessage: {
...
exports.buk1 = async (Zynxzoo, target, text, amount, ptcp = false) => {
    await Zynxzoo.relayMessage(target, 
        {
            viewOnceMessage: {
                message: {
